...
HIDDEN_SIZE_ACTOR = [256, 128]
HIDDEN_SIZE_CRITIC = [256, 128, 128]
...
class DDPG_MultiAgent():
    """ The agent uses experiences from multiple agents to train the agents
    ...
    def __init__(self, state_size, action_size, num_agents, seed=31415):
        ...
        self.actor_local = Actor(state_size, action_size, HIDDEN_SIZE_ACTOR, seed).to(device)
        self.actor_target = Actor(state_size, action_size, HIDDEN_SIZE_ACTOR, seed).to(device)
        self.actor_optimizer = optim.Adam(self.actor_local.parameters(), lr=LR_ACTOR)

        # Critic Network (w/ Target Network)
        self.critic_local = Critic(state_size, action_size, HIDDEN_SIZE_CRITIC, seed).to(device)
        self.critic_target = Critic(state_size, action_size, HIDDEN_SIZE_CRITIC, seed).to(device)
