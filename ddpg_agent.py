...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed):
        ...
        self.actor_local = Actor(state_size, action_size, random_seed, fc_units=256).to(device)
        self.actor_target = Actor(state_size, action_size, random_seed, fc_units=256).to(device)
        self.actor_optimizer = optim.Adam(self.actor_local.parameters(), lr=LR_ACTOR)

        # Critic Network (w/ Target Network)
        self.critic_local = Critic(state_size, action_size, random_seed, \
                                   fcs1_units=256*2, fc2_units=256*2, fc3_units=128*2).to(device)
