...
HIDDEN_SIZE_ACTOR = [256, 128]        # number of nodes in Actor's fully connected layers
HIDDEN_SIZE_CRITIC = [256, 128, 128]  # number of nodes in Critic's fully connected layers
...
class DDPG_Agent():
    ...
    def __init__(self, state_size, action_size, num_agents, seed=31415):
        ...
        self.actor_local = Actor(state_size, action_size, hidden_size=HIDDEN_SIZE_ACTOR).to(device)
        self.actor_target = Actor(state_size, action_size, hidden_size=HIDDEN_SIZE_ACTOR).to(device)
    ...
    def step(self, states, actions, rewards, next_states, dones):
        ...
        if (self.steps % 20 == 0) and (len(self.memory) > 10 * BATCH_SIZE):
            for _ in range(10):
...
class ReplayBuffer:
    ...
    def __init__(self, action_size, buffer_size, batch_size, seed=31415):
